...
- The applause bot (code snippit below) cannot yet identify categories behind the applause, it can only detect moments and lengths of applause (working on a fix)
